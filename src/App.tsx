...
function MaterialDetailPage({ forcedId }: { forcedId?: string } = {}) {
  const { id: routeId = '' } = useParams(); const id = forcedId ?? routeId; const validId = isValidMaterialId(id); const navigate = useNavigate(); const [searchParams] = useSearchParams();
