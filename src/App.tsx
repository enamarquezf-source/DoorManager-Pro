...
function PurchaseOrderDetail({ id, suppliers, warehouses, materials, canManage, onChanged }: any) {
  ...
  const [edit, setEdit] = useState(false); const [addingLine, setAddingLine] = useState(false); const [editingLine, setEditingLine] = useState<any | null>(null); const [actionError, setActionError] = useState('');
  ...
  const data = order.data; const lines = data.purchase_order_lines ?? []; const refresh = () => { order.reload(); onChanged(); };
