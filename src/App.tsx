...
import { canAccessModule, canAssignTechnician, canCreateAlert, canCreateCheck, canCreateWorkOrder, canEditWorkOrder, canExecuteWorkOrder, canViewWorkOrder, isSuperadmin } from './auth/permissions';
...
function ProtectedLayout() {
  ...
  const allowedWorkspaces = isSuperadmin(profile) ? ['superadmin' as Workspace] : [...new Set([roleToWorkspace[profile.primary_area], ...profile.roles.map((role) => roleToWorkspace[role])].filter(Boolean))] as Workspace[];
