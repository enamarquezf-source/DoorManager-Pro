...
import { canAccessModule, canAccessRoute, canArchiveEntity, canAssignTechnician, canCorrectWorkOrderOperationalFields, canCreateAlert, canCreateCheck, canCreateWorkOrder, canDeleteInvoiceDraft, canEditWorkOrder, canExecuteCheck, canExecuteWorkOrder, canManageCheck, canManageEquipmentTypes, canManageHourRates, canManageQuotes, canManageSuppliers, canManageWorkOrderAssignments, canManageWorkOrderCosts, canManageWorkOrderMaterials, canManageWorkOrderStatus, canManageWorkOrderTime, canMarkAdditionalSale, canPermanentlyDeleteEntity, canRestoreEntity, canReviewWorkOrderCommercial, canReviewWorkOrderEconomic, canReviewWorkOrderOffice, canReviewWorkOrderSat, canRole, canViewCheck, canViewInternalEconomics, canViewSuppliers, canViewWorkOrder, canViewWorkOrderCosts, isSuperadmin, normalizedRoleNames, profileWorkspaces } from './auth/permissions';
...
const superadminSharedRoutes = ['/app/modulos/presupuestos', '/app/modulos/materiales', '/app/modulos/administracion', '/app/modulos/facturacion', '/app/modulos/cobros', '/app/modulos/rentabilidad', '/app/modulos/tarifas-horas', '/app/modulos/tipos-equipo'];
