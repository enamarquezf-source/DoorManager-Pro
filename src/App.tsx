...
function NotFound() {
  ...
  if (superadminCheckBlockMatch) return <SuperadminGuard><CheckBlockPage forcedId={superadminCheckBlockMatch[1]} forcedBlockId={superadminCheckBlockMatch[2]} /></SuperadminGuard>;
