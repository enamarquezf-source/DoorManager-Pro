...
export function isQuoteEditable(status?: string | null) {
  return status === 'Borrador' || status === 'Enviado';
}

export function validQuoteTransitions(status?: string | null) {
  const transitions: Record<string, string[]> = {
    Borrador: ['Enviado', 'Aceptado', 'Rechazado', 'Caducado', 'Cancelado'],
    Enviado: ['Borrador', 'Aceptado', 'Rechazado', 'Caducado', 'Cancelado'],
    Aceptado: ['Rechazado', 'Caducado', 'Cancelado', 'Ejecutado en cliente'],
    'Ejecutado en cliente': [],
    Rechazado: ['Borrador', 'Enviado'],
    Caducado: ['Borrador', 'Enviado'],
    Cancelado: ['Borrador', 'Enviado'],
  };
...
const lineColumns = ['quote_id', 'line_type', 'description', 'quantity', 'unit', 'unit_cost', 'unit_price', 'tax_rate', 'material_id', 'profile_id', 'position', 'discount_percent', 'quote_rate_id', 'concept_id', 'rate_version_id', 'billing_mode', 'period_days', 'contributes_to_sale'];
...
export const quotesService = {
  async list(search = '', status = 'Todos', companyScope?: string | null, archiveFilter: ArchiveFilter = 'active', dateFilters: DateRangeFilters = {}) {
